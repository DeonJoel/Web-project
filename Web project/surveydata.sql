...
INSERT INTO `surveydtails` (`sl.no`, `Area`, `SubArea`, `TotalPopulation`, `NoOfAcc`, `NoOfCredit`, `NoOfDebit`) VALUES
(1, 'Manglore', 'Manglore-Center', 20000, 19400, 9000, 10200),
(2, 'Manglore', 'Manglore-South', 34909, 34545, 2136, 29000),
...
(79, 'Gadag-Betageri', 'Basavanagudi', 20306, 19934, 5134, 16500),
...
INSERT INTO `users` (`sl.no`, `UserName`, `Password`) VALUES
(1, 'DeonPinto', 'Deon123'),
(2, 'Arun', 'Arun123'),
(3, 'Adarsh', 'Adarsh123');
...
--
ALTER TABLE `surveydtails`
  MODIFY `sl.no` int(99) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=146;

--
-- AUTO_INCREMENT for table `users`
--
ALTER TABLE `users`
  MODIFY `sl.no` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
COMMIT;
